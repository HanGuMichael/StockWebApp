...
*/
public class RemovestockMobileStepDefinitions {
	...
	public void in_mainpage_and_logged_in_rmsm() {
		new DropUserTable();
		new CreateUserTable();
	...
	public void i_add_a_stock_rmsm() {
	...
	public void i_should_see_the_delete_button_rmsm() {
		WebDriverWait wait = new WebDriverWait(driver, 10);
	...
	public void I_should_be_able_to_click_the_clickable_delete_button_rmsm() {
	...
	public void in_mainpage_logged_in_and_add_a_stock_rmsm() {
		new DropUserTable();
		new CreateUserTable();
		new InitializeUserTable();
	    driver.get(ROOT_URL);
	...
	public void i_click_the_delete_button_rmsm() {
		WebDriverWait wait = new WebDriverWait(driver, 10);
		By title = By.xpath("//*[@id=\"BTC\"]/table/tbody/tr/td[3]/div");
		wait.until(ExpectedConditions.visibilityOfElementLocated(title));
		driver.findElement(title).click();
	...
	public void i_should_see_the_text_Do_you_want_to_delete_ticker_AMZN_rmsm() {
	...
	public void i_should_the_delete_stock_button_rmsm() {
	...
	public void i_should_the_no_button_rmsm() {
	...
	public void i_should_be_able_to_click_the_clickable_delete_stock_button_rmsm() {
		WebDriverWait wait2 = new WebDriverWait(driver, 10); 
	...
	public void i_should_be_able_to_click_the_clickable_cancel_button_rmsm() {
		WebDriverWait wait2 = new WebDriverWait(driver, 10); 
	...
	@When("I click the no button rmsm")
	public void i_click_the_no_button_rmsm() {
		driver.findElement(By.xpath("//*[@id=\"addStock-form\"]/div[1]/button[2]")).click();
	}

	@Then("there is still the stock that I added rmsm")
	public void there_is_still_the_stock_that_I_added_rmsm() {
		WebDriverWait wait = new WebDriverWait(driver, 10);
	...
	@When("I click the delete button for the stock and click the yes button rmsm")
	public void i_click_the_delete_button_for_the_stock_and_click_the_yes_button_rmsm() {
	...
	public void there_should_be_gone_that_I_intend_to_delete_rmsm() {
